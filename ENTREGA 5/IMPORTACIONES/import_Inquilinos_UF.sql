...
-- Insertamos los tipos de relación que una persona puede tener con una UF
-- (El ID_Tipo_Relacion_P_U es IDENTITY, por eso no lo especificamos)

INSERT INTO TipoRelacionPersonaUnidad (Nombre) 
VALUES 
    ('Propietario'), -- Se insertará con ID = 1
    ('Inquilino');   -- Se insertará con ID = 2
GO
...
CREATE TABLE [Unidad_Funcional-Persona] (
	id_UP INT PRIMARY KEY IDENTITY(1,1),
